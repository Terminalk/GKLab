...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl2.glMaterialfv (GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, materials[6], 0);
        gl2.glMaterialfv (GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, materials[6], 4);
        gl2.glMaterialfv (GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[6], 8);
        gl2.glMaterialf (GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, materials[6][12]);
        ...
        // Tył
        gl2.glColor3f( 1.0f, 1.0f, 0.0f ); // green
        ...
        //Lewa
        gl2.glColor3f( 1.0f, 1.0f, 1.0f ); // green
        ...
        gl2.glColor3f( 0.5f, 0.0f, 1.0f ); // green
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        float [] l_color1 = {1f, 1f, 1f, 0.0f};
        float [] l_color2 = {1f, 1f, 1f, 0.0f};
        float [] l_color3 = {1f, 1f, 1f, 0.0f};
        gl2.glLightfv (GL2.GL_LIGHT0, GL2.GL_DIFFUSE, l_color1, 0);
        gl2.glLightfv (GL2.GL_LIGHT0, GL2.GL_SPECULAR, l_color2, 0);
        gl2.glLightfv (GL2.GL_LIGHT0, GL2.GL_AMBIENT, l_color3, 0);

        gl2.glTranslatef(0f,0f,0f);
        float [] position = { 1f,0f,0f,0f };
        gl2.glLightfv(GL2.GL_LIGHT0, GL2.GL_POSITION, position, 0);

//        float [] mat_specular = { 1.0f, 1.0f, 1.0f, 1.0f };
//        float [] mat_shininess = { 0.05f };
